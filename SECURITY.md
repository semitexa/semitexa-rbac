...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-rbac/security/advisories/new).
...
In scope: anything in `semitexa/rbac` that lets a request, a job or a message do
